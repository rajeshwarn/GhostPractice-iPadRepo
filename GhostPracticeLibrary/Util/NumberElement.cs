...
namespace GhostPractice
{
	public class NumberElement : OwnerDrawnElement
	{
		...
		private UIFont amountFont = UIFont.BoldSystemFontOfSize (14.0f);

		public NumberElement (int number, string caption) : base(UITableViewCellStyle.Default, "financeElement")
		{
			this.Label = caption;
			this.Number = number;
			SetUp ();
