...
namespace GhostPractice
{
	...
	/// </remarks>
	public class MultiEntryElement : Element, IElementSizing
	{
		/// <summary>
		...
		/// </summary>
		static NSString entryKey = new NSString ("MultiEntryElement");
		...
		private UIFont inputFont = UIFont.SystemFontOfSize(15);
		public UIFont Font {
			get {
				return inputFont;
			}
...
//		public event Func<bool> ShouldReturn;
		...
		/// Initial value.
		/// </param>
		public MultiEntryElement (string caption, string value) : base (caption)
		{ 
			Value = value;
		}
