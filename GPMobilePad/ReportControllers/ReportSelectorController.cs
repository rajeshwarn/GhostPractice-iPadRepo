...
namespace GPMobilePad
{
	public partial class ReportSelectorController : DialogViewController
	{
		...
		public BohaPageViewController bohaPageController { get; set; }

		private ReportsDataSource reportSource;
		//		UIBarButtonItem btnClose;
		//		bool isStartingUp;
		//
		public ReportSelectorController (BohaPageViewController pageController, bool getFinanceReport) : base (UITableViewStyle.Grouped, null)
		{
			this.bohaPageController = pageController;
		...
		private void navigateToReport (int type)
		{
			...
			if (bohaPageController != null) {
				bohaPageController.SetReportPages (financeReport, feeTargetReport, matterAnalysisReport);
				return;
			}
