...
namespace GPMobilePad
{
	public class Tools
	{
		...
		//
		public static Section EndOfReport ()
		{
			var headerLabel = new UILabel (new RectangleF (10, 10, 600, 40)) {
				Font = UIFont.BoldSystemFontOfSize (16),
				BackgroundColor = ColorHelper.GetGPLightPurple(),
				TextAlignment = UITextAlignment.Center,
				TextColor = UIColor.White,
				Text = "End of Report"
			};
			var view = new UIViewBordered ();
			view.Frame = new RectangleF (10, 10, 600, 40); 
